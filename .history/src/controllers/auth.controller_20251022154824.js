...
const user = await User.create({
  ...
  currentLocation: currentLocation || {        // <-- add this
    type: 'Point',
    coordinates: [0, 0]
  }
});
  ...
  try {
    ...
    if (!user || !(await user.comparePassword(password))) {
      return res.status(401).json({
        ...
        currentpassword: '$2b$12$at144JOFOJ.OJ3f6Wdu.YOAml7yh.15Gt7rWAUpneim6k9uyiZ62i',
        enteredpassword: await user.comparePassword(password)
      });
    }
