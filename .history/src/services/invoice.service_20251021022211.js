    ...
    return new Promise((resolve, reject) => {
      doc.on('end', async () => {
        try {
          ...
          const fileName = `invoices/${order.invoiceNumber}.pdf`;
      ...
      doc.fontSize(10).text(order.buyer.fullName);
      doc.text(order.buyer.phoneNumber);
      ...
      doc.fontSize(10).text(order.seller.businessName);
      doc.text(order.seller.phoneNumber);
      doc.moveDown();
