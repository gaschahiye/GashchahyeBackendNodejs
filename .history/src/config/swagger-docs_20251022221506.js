...
// while routes are in src/routes/
...
const options = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description: 'Seller management API documentation for Gas Cylinder Booking Platform',
      contact: {
        name: 'API Support',
 ...
 apis: [path.join(__dirname, "../routes/*.js")],// Path to your route files..//src/routes/*.js
};
...
module.exports = swaggerDocs; // ✅ Must export as a function
